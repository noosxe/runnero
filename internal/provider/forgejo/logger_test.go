...
// logger (RUN-8 acceptance): records carry module="provider.forgejo", and level
...
func TestModuleLoggerTagged(t *testing.T) {
	...
	out := buf.String()
	if !strings.Contains(out, "\"module\":\"provider.forgejo\"") || !strings.Contains(out, "\"msg\":\"beacon\"") {
