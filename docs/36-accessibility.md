...
| `/` dashboard, `/pools`, `/pools/:id` (default tab), `/pools/:id/config`, `/logs`, `/history`, `/history/:id`, `/profiles`, `/renovate`, `/settings` (admin default = constraints), `/settings/users` | admin | light, dark |
