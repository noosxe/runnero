  ...
  if (!pool) {
    return (
      <div className="flex flex-col gap-4">
        <Link
          to="/pools"
          className="inline-flex items-center gap-1.5 self-start text-xs font-semibold text-link hover:underline"
        >
      ...
      <div>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="rounded-md bg-primary/10 px-2.5 py-1 text-xs font-semibold text-link uppercase tracking-wider border border-primary/30 ">
              {pool.provider}
            </span>
